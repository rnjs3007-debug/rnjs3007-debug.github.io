...
<div style="max-width:860px;margin:0 auto;padding:48px 32px 32px;font-family:'Noto Sans KR',sans-serif;">
  <div style="margin-bottom:40px;">
    ...
    <h1 style="font-size:26px;font-weight:700;margin:12px 0 8px;color:#37352f;">📊 Data Analysis</h1>
    <p style="font-size:14px;color:#aaa;">데이터 분석 학습 기록</p>
  </div>
  ...
  {% assign cat_posts = site.posts | where_exp: "post", "post.categories contains 'data-analysis'" %}
  {% if cat_posts.size > 0 %}
